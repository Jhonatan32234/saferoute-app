...
class ReporteProvider extends ChangeNotifier {
  ...
  Future<void> enviarReporte({
    ...
    try {
      ...
      // Limpiamos el error de cualquier prefijo técnico como "Exception: "
      final errorStr = e.toString().replaceFirst('Exception: ', '').trim();
      ...
      // El error desaparecerá tras 3 segundos para una UX más limpia
